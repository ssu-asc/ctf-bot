  ...
  if (state.channelId) {
    ...
    const channel = matches[0] || await api(`/guilds/${config.guildId}/channels`, {
      ...
      body: JSON.stringify({
        ...
        topic: `${field.emoji} ${field.name}에 관심 있는 멤버들이 주제를 제안하고 팀을 찾는 곳입니다. 팀은 2~3명 권장, 최대 4명이며 PM 1명을 정해주세요.`,
